...
export function CreateGroupModal({ allUsers = [], onClose, onSubmit }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (selectedUserIds.length === 0) {
      alert('Please assign at least one member to the group.');
      return;
    }
        ...
        <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-base font-bold text-slate-900 dark:text-white">
              Create Group Circle & Assign Members
            </h3>
          </div>
          <button
            type="button"
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. Annapurna Trek Expedition"
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="e.g. Shared lodge, transport, food, and porter expenses"
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className="text-[11px] text-slate-400">
                First selected will be designated creator
              </span>
            </div>
